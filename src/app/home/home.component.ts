...
import { TestimonialComponent } from "../patient/testimonial/testimonial.component";
import { HistoriqueComponent } from '../admin/historique/historique.component';

@Component({
  selector: 'app-home',
  standalone: true,
  imports: [AboutComponent, HistoriqueComponent, ContactComponent, AppointmentComponent, TestimonialComponent],
